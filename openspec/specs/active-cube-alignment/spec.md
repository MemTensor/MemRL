# active-cube-alignment

## Purpose
Ensure `MemoryService` and any cube-bound subcomponents operate against the same active MemOS cube after resume-from-checkpoint or explicit cube switching.
